...
mod = "mod4"
terminal = "alacritty"
myconfig = "/home/phuoclong/.config/qtile/config.py"
home = "/home/phuoclong/"
...
keys = [
    ...
    Key(
        [mod, "shift"],
        "a",
        lazy.spawn("code /home/phuoclong/.config/qtile/"),
        desc="Config qtile",
    ),
    ...
    Key(
     ...
     Key(
        [],
        "XF86MonBrightnessUp",
        lazy.spawn("sh /home/phuoclong/.config/qtile/eww_bright.sh up"),
        desc="Increase brightness",
     ),
     Key(
        [],
        "XF86MonBrightnessDown",
        lazy.spawn("sh /home/phuoclong/.config/qtile/eww_bright.sh down"),
...
workspaces = [
    ...
    {"name": "", "key": "5", "matches": [Match(wm_class=terminal), Match(wm_class="alacritty"),
    ...
    {"name": "", "key": "9", "matches": [Match(wm_class="nautilus")]},
    {
        "name": "",
        "key": "0",
        "matches": [
...
def toggle_bluetooth():
    qtile.cmd_spawn("sh ~/.config/qtile/system-bluetooth-bluetoothctl.sh --toggle")
...
screens = [
    Screen(
        wallpaper="~/images/dnord4k_dark.png",
        wallpaper_mode="fill",
        top=bar.Bar(
            [
                # widget.Image(
                ...
                widget.Battery(
                    ...
                    format= "{percent:2.2%} {hour:d}:{min:02d}",
                    update_interval=0.1,
                ),
